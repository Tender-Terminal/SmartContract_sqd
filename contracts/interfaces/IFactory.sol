...
interface IFactory {
    ...
    function mintNew(string memory _nftURI, string memory _name, string memory _symbol, string memory _description, uint256 _loyaltyFee) external returns (address);
